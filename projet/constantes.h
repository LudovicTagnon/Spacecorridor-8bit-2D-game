//
// Created by ludovic on 06/04/2021.
//

#ifndef MAIN_C_CONSTANTES_H
#define MAIN_C_CONSTANTES_H
...
#define NUMBER_OF_WALLS 12


/**
  * \brief NOMBRES DE VIES AU DEPART
*/

#define NUMBER_OF_LIFES 3


#endif //MAIN_C_CONSTANTES_H
